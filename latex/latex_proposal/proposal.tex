...
\cmt{search history, search option, search auto completion 추가}
...
\cmt{Auto Compile Test - Validation} 
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{./figures/use_case_overall.jpg}
%text slot
